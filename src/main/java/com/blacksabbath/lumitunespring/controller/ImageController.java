...
public class ImageController {
    ...
    public ResponseEntity<?> uploadImage(@RequestParam("file") MultipartFile file, HttpServletRequest request, HttpServletResponse response) {
        try {
        	Cookie cookie = null;
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> getImage(@RequestParam String id, HttpServletRequest request, HttpServletResponse response){
