...
public class RegionController {
		...
		public ResponseEntity<List<RegionDto>> getRegionsByParentId(@PathVariable String parentId ,HttpServletRequest request, HttpServletResponse response){
	    ...
	    @ApiResponses({
	        ...
	        @ApiResponse(responseCode = "404", description = "Регіон не знайдено", content = @Content(
	            mediaType = "application/json",
	            schema = @Schema(implementation = Map.class),
	            examples = @ExampleObject(value = "{\"error\": \"Region not found\"}")
	        )),
	        @ApiResponse(responseCode = "500", description = "Помилка сервера")
	    })
		public ResponseEntity<?> getById(@PathVariable String id,HttpServletRequest request, HttpServletResponse response){
	    ...
	    @ApiResponses({
	        ...
	        @ApiResponse(responseCode = "500", description = "Помилка при оновленні регіону", content = @Content(
	            mediaType = "application/json",
	            schema = @Schema(implementation = Map.class),
